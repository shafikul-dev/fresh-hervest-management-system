    ...
    <footer className="bg-gray-100 py-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Quick Links 1 */}
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Quick Links 1</h3>
          ...
          {/* Quick Links 2 */}
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Quick Links 2</h3>
            <ul className="space-y-3">
              <li>
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                {/* Apple Pay */}
                <div className="bg-black text-white px-3 py-2 rounded text-sm font-bold flex items-center space-x-1">
